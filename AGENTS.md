...
- Platforms: **Windows** (stable) · **macOS** (stable) · **Linux** (preview) · **iOS** (preview) · **Android** (preview)
...
Sources/
  ...
  KalsaePlatformIOS/       UIKit + WKWebView PAL (preview)
  KalsaePlatformAndroid/   JNI + Android WebView PAL (preview)
...
- iOS/Android CI is not yet configured in `.github/workflows/`.
